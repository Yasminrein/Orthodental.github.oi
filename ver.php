...
<body onload="myFunction()">
    ...
    <!-- Footer Start -->
    <div class="container-fluid footer bg-dark text-white-50 py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <div class=" g-5 py-5">
            <div class="col-lg-6 pe-lg-5">
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <a class="btn btn-lg-square btn-primary me-5" href="#"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </div>
        </div>

            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="index.php" class="nav-link nav-link" >Services</a>
                    </div>
...
<div class="card o-hidden border-0 shadow-lg my-5" >
  <div class="card-body p-0">
    ...
    <div class="row">
    <div class="col-lg-4 d-none d-lg-flex align-items-center justify-content-center" style="border-right: 1px black solid; ">
        <img src="img/logos_clear.png" style="width: 300px;">
    </div>
    <div class="col-lg-8">
  <div class="p-5">
    <div class="text-center">
      <h1 class="h3 text-white-900 mb-4">Create an Account</h1>
    </div>
    <form class="user" action="./endpoint/add-user.php" method="POST" enctype="multipart/form-data" autocomplete="off">
      <div class="form-group row">
        ...
        <div class="col-sm-2 mb-2">
          <input type="text" class="form-control" style="text-transform:capitalize;" placeholder="Suffix" name="suffix">
        </div>
      </div><br> 
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" pattern="^[A-Za-z0-9.-]*$" oninput="validateInput(this)" required = "required" name="username2" id="username2" placeholder="User Name">
                    <small class="form-text text-muted">Only letters, numbers, '.' and '-' are allowed.</small>
                    <div id="status"></div>
                </div>
            ...
            <div class="form-group row">
              <div class="col-sm-4 mb-3 mb-sm-0">
                <input type="text" class="form-control"   style=" text-transform:capitalize;"required = "required" maxlength="11" placeholder="Contact" name = "contact" >
              </div>
              <!-- <div class="col-sm-4 mb-3 "><input type="date" class="form-control" style="text-transform:capitalize;" required="required" placeholder="First Name" name="bdate" max="<?php echo date('Y-m-d', strtotime('-1 day')); ?>"> -->
                <div class="col-sm-4 mb-3">
                    <input type="date" class="form-control" style="text-transform:capitalize;" required="required" placeholder="First Name" name="bdate" id="bdate">
                </div>
                ...
                <script>
                    ...
                    // Subtract 18 years from today to get the maximum date allowed for 18 years old
                ...
                <script>
                // JavaScript function to restrict input
...
if(isset($_POST['register'])){
  ...
  $address = $_POST['address'];
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $code = date('mdysih');
        $sql = "INSERT INTO user_account1 (username,email,param_password,fname,mname,lname,position,contact,bdate,gender,address) VALUES (?,?,?,'$fname','$mname','$lname','$code','$contact','$bdate','$gender','$address')";

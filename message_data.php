            ...
            <div class="card card-prirary cardutline direct-chat direct-chat-primary" >
              ...
              <div class="card-body" >
                <!-- <div class="direct-chat-messages fix " id="message-content" style=" overflow-x: hidden; height:400px;overflow: scroll;display: flex;flex-direction: column-reverse;"> -->
				...
				<?php
				$id_faculty = $u_id;
				$q_e = $conn->query("SELECT * FROM `chat` WHERE `chat_user`='$id_faculty' ORDER BY `chat_time` DESC") or die(mysqli_error($conn));
                ...
                <div class="direct-chat-msg">
					...
					<span class="direct-chat-timestamp float-left" style="font-size:10px;"><?php echo $chat_time?> </span><br>
						...
						<!-- <a href="#" ><?php //echo $f1['fname']." ".$f1['lname']?></a></b></span> -->
						<a href="#" ><?php
                        if ($chat_user_id != $u_id) {
				...
				<div class="direct-chat-infos clearfix">
					<span class="direct-chat-timestamp" style="font-size:10px;float:right;"><?php echo $chat_time?></span><br>
						<span class="direct-chat-name float-right text-dark" style="text-transform:capitalize; float:right;"><b>
						<?php echo $f1['fname']." ".$f1['lname']?></b></span>
			  ...
			  <input type="hidden" value="<?php echo $_GET['code'];?>" name="code">
				  ...
				  <!-- <input type="file" name="file" class="form-control" width="50px"> -->
                </form>
				 <?php 
				if(isset($_POST['send'])){
					$u_id1 = $u_id;
